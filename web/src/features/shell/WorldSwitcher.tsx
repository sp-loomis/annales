...
function WorldRow({ world, active, onSelect }: { world: World; active: boolean; onSelect: () => void }) {
  ...
  return (
    ...
    >
      <span className={styles.accentDot} style={{ background: theme?.accentColor ?? 'var(--accent)' }} />
